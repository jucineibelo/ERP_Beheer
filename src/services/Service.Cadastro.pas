...
type
  TServiceCadastro = class(TDataModule)
    ...
    Qry_CaixaDESC_FORMA_PAG: TStringField;
    Qry_FormaPagamentoGERA_RECEBER: TStringField;
    Qry_Contas_Receber: TFDQuery;
    Qry_Contas_Rec_detalh: TFDQuery;
    Qry_Contas_Rec_detalhID: TIntegerField;
    Qry_Contas_Rec_detalhDOCUMENTO: TStringField;
    Qry_Contas_Rec_detalhDATA: TDateField;
    Qry_Contas_Rec_detalhVALOR: TFMTBCDField;
    Qry_Contas_Rec_detalhPARCELA: TStringField;
    Qry_Contas_Rec_detalhDATA_VENCIMENTO: TDateField;
    Qry_Contas_Rec_detalhARECEBER: TFMTBCDField;
    Qry_Contas_Rec_detalhSALDO: TFMTBCDField;
    Qry_Contas_ReceberID: TIntegerField;
    Qry_Contas_ReceberID_CLIENTE: TIntegerField;
